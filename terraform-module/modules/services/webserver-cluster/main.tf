...
resource "aws_security_group_rule" "allow-sever_http_inbound"{
  type              =  "ingress"
...
resource "aws_security_group_rule" "allow_http_inbound" {
    ...
    from_port   = local.http_port            #출발포트
    to_port     = local.http_port            #도착포트
    protocol    = local.tcp_protocol         #프로토콜
    cidr_blocks = local.all_ips              # 송신지
  }
resource "aws_security_group_rule" "allow_all_outbound"{
  ...
  from_port   = local.any_port             #출발포트
  to_port     = local.any_port             #도착포트
